...
if ( EXISTS "/etc/os-release" )
  ...
  elseif( ${OS_RELEASE_ID} STREQUAL "opensuse" )
    ...
    configure_file(${CMAKE_CURRENT_SOURCE_DIR}/tools/lard/opensuse/init.d/lard ${CMAKE_CURRENT_BINARY_DIR}/init.d/lard @ONLY)
    ...
    set( CPACK_RPM_lard_POST_INSTALL_SCRIPT_FILE "${CMAKE_CURRENT_SOURCE_DIR}/tools/lard/opensuse/postinstall.sh" )
    set( CPACK_RPM_lard_PRE_UNINSTALL_SCRIPT_FILE "${CMAKE_CURRENT_SOURCE_DIR}/tools/lard/opensuse/preuninstall.sh" )
  ...
  elseif( ${OS_RELEASE_ID} STREQUAL "debian" )
    ...
    configure_file(${CMAKE_CURRENT_SOURCE_DIR}/tools/lard/debian/init.d/lard ${CMAKE_CURRENT_BINARY_DIR}/init.d/lard @ONLY)
    if ( ${LEANUX_DEB_MONOINSTALL} STREQUAL "1" )
      ...
      set( CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA "${CMAKE_CURRENT_SOURCE_DIR}/tools/lard/debian/postinst;${CMAKE_SOURCE_DIR}/tools/lard/debian/prerm;")
    else()
      install(FILES ${CMAKE_CURRENT_BINARY_DIR}/lard.conf DESTINATION "/etc/lard" COMPONENT lard)
      install(FILES ${CMAKE_CURRENT_BINARY_DIR}/init.d/lard DESTINATION "/etc/init.d" COMPONENT lard)
      set(C PACK_DEBIAN_PACKAGE_CONTROL_EXTRA "${CMAKE_CURRENT_SOURCE_DIR}/tools/lard/debian/postinst;${CMAKE_SOURCE_DIR}/tools/lard/debian/prerm;" COMPONENT lard)
    endif()
    set( OS_RELEASE_TAG "${OS_RELEASE_ID}_${OS_RELEASE_VERSION_ID}" )
    set( INSTALL_LIB_PATH "lib" )
    set( CPACK_GENERATOR "DEB")
  ...
  elseif( ${OS_RELEASE_ID} STREQUAL "centos" )
    ...
    install(FILES ${CMAKE_CURRENT_BINARY_DIR}/lard.conf DESTINATION "/etc/lard" COMPONENT lard)
    install(FILES ${CMAKE_CURRENT_BINARY_DIR}/init.d/lard DESTINATION "/etc/init.d" COMPONENT lard)
    set( CPACK_RPM_lard_POST_INSTALL_SCRIPT_FILE "${CMAKE_CURRENT_SOURCE_DIR}/tools/lard/centos/postinstall.sh" )
    set( CPACK_RPM_lard_PRE_UNINSTALL_SCRIPT_FILE "${CMAKE_CURRENT_SOURCE_DIR}/tools/lard/centos/preuninstall.sh" )
    set( CPACK_RPM_EXCLUDE_FROM_AUTO_FILELIST_ADDITION /usr /usr/bin /usr/include /usr/lib64 /usr/share /usr/share/man /usr/share/man/man1 )
    set( CPACK_GENERATOR "RPM" )
    set( OS_RELEASE_TAG "el${OS_RELEASE_VERSION_ID}" )
    set(DIST_PKG_SQLITE3 "sqlite")
  ...
  elseif( ${OS_RELEASE_ID} STREQUAL "fedora" )
    ...
    install(FILES ${CMAKE_CURRENT_BINARY_DIR}/lard.conf DESTINATION "/etc/lard" COMPONENT lard)
    install(FILES ${CMAKE_CURRENT_BINARY_DIR}/init.d/lard DESTINATION "/etc/init.d" COMPONENT lard)
    set( CPACK_RPM_lard_POST_INSTALL_SCRIPT_FILE "${CMAKE_CURRENT_SOURCE_DIR}/tools/lard/fedora/postinstall.sh" )
    set( CPACK_RPM_lard_PRE_UNINSTALL_SCRIPT_FILE "${CMAKE_CURRENT_SOURCE_DIR}/tools/lard/fedora/preuninstall.sh" )
    set( CPACK_RPM_EXCLUDE_FROM_AUTO_FILELIST_ADDITION /usr /usr/bin /usr/include /usr/lib64 /usr/share /usr/share/man /usr/share/man/man1 )
    set( OS_RELEASE_TAG "${OS_RELEASE_ID}_${OS_RELEASE_VERSION_ID}" )
    set(CPACK_GENERATOR "RPM")
...
set(CPACK_PACKAGE_FILE_NAME "leanux-${leanux_VERSION_STR}.${OS_RELEASE_TAG}.${CMAKE_SYSTEM_PROCESSOR}")

if ( ${CPACK_GENERATOR} STREQUAL "RPM" )
  set( CPACK_RPM_PACKAGE_REQUIRES "${DIST_PKG_NCURSES}, ${DIST_PKG_ZLIB}, ${DIST_PKG_SQLITE3} >= 3.7.0, ${DIST_PKG_PCIIDS}, ${DIST_PKG_USBIDS}" )
  set( CPACK_RPM_lard_PACKAGE_REQUIRES "leanux-libleanux" )
  set( CPACK_RPM_lmon_PACKAGE_REQUIRES "leanux-libleanux" )
  set( CPACK_RPM_lsys_PACKAGE_REQUIRES "leanux-libleanux" )
  set( CPACK_RPM_lblk_PACKAGE_REQUIRES "leanux-libleanux" )
  set( CPACK_RPM_lrep_PACKAGE_REQUIRES "leanux-libleanux" )
  set( CPACK_RPM_labbix_PACKAGE_REQUIRES "leanux-libleanux" )
elseif ( ${CPACK_GENERATOR} STREQUAL "DEB" )
  set( CPACK_DEBIAN_PACKAGE_DEPENDS "${DIST_PKG_NCURSES}, ${DIST_PKG_ZLIB}, ${DIST_PKG_SQLITE3} (>= 3.7.0), ${DIST_PKG_PCIIDS}, ${DIST_PKG_USBIDS}" )
  # CPACK_DEBIAN_<COMPONENT>_PACKAGE_DEPENDS is not supported (ineffective) until cmake 3.3.2
  if ( ${LEANUX_DEB_MONOINSTALL} STREQUAL "1" )
    # install everything, so no interdependencies
  else()
    set( CPACK_DEBIAN_lard_PACKAGE_DEPENDS "leanux-libleanux" )
    set( CPACK_DEBIAN_lmon_PACKAGE_DEPENDS "leanux-libleanux" )
    set( CPACK_DEBIAN_lsys_PACKAGE_DEPENDS "leanux-libleanux" )
    set( CPACK_DEBIAN_lblk_PACKAGE_DEPENDS "leanux-libleanux" )
    set( CPACK_DEBIAN_lrep_PACKAGE_DEPENDS "leanux-libleanux" )
    set( CPACK_DEBIAN_labbix_PACKAGE_DEPENDS "leanux-libleanux" )
  endif()
endif()
