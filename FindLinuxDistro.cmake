...
elseif ( ${CPACK_GENERATOR} STREQUAL "DEB" )
  ...
  if ( ${${PROJECTUC}_DEB_MONOINSTALL} STREQUAL "1" )
    ...
    set( CPACK_COMPONENT_lard_DEPENDS "${PROJECT}-lib${PROJECT}" )
    set( CPACK_COMPONENT_lmon_DEPENDS "${PROJECT}-lib${PROJECT}" )
    set( CPACK_COMPONENT_lsys_DEPENDS "${PROJECT}-lib${PROJECT}" )
    set( CPACK_COMPONENT_lblk_DEPENDS "${PROJECT}-lib${PROJECT}" )
    set( CPACK_COMPONENT_lrep_DEPENDS "${PROJECT}-lib${PROJECT}" )
    set( CPACK_COMPONENT_labbix_DEPENDS "${PROJECT}-lib${PROJECT}" )
  endif()
endif()
